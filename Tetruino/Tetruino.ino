...
logoBuild(2,249,251,252);
logoBuild(3,255,255,255);
logoBuild(4,244,248,250);
logoBuild(5,226,236,242);
logoBuild(6,255,255,255);
logoBuild(7,226,236,242);
logoBuild(8,255,255,255);
logoBuild(9,255,255,255);
logoBuild(10,255,255,255);
logoBuild(11,255,255,255);
logoBuild(12,149,182,203);
logoBuild(13,244,247,249);
logoBuild(14,193,212,226);
logoBuild(15,255,255,255);
logoBuild(16,225,235,240);
logoBuild(17,236,243,247);
logoBuild(18,255,255,255);
logoBuild(19,255,255,255);
logoBuild(20,255,255,255);
logoBuild(21,255,255,255);
logoBuild(22,255,255,255);
logoBuild(23,226,235,239);
logoBuild(24,209,218,227);
logoBuild(25,101,144,179);
logoBuild(26,73,119,161);
logoBuild(27,75,135,177);
logoBuild(28,255,255,255);
logoBuild(29,255,255,255);
logoBuild(30,255,255,255);
logoBuild(31,255,255,255);
logoBuild(32,130,162,187);
logoBuild(33,27,103,156);
logoBuild(34,255,255,255);
logoBuild(35,234,239,244);
logoBuild(36,244,248,250);
logoBuild(37,209,210,217);
logoBuild(38,255,255,255);
logoBuild(39,255,255,255);
logoBuild(40,255,255,255);
logoBuild(41,209,190,201);
logoBuild(42,147,148,208);
logoBuild(43,255,255,255);
logoBuild(44,232,240,245);
logoBuild(45,238,245,248);
logoBuild(46,0,80,140);
logoBuild(47,98,147,183);
logoBuild(48,219,223,225);
logoBuild(49,255,255,255);
logoBuild(50,232,238,242);
logoBuild(51,137,176,200);
logoBuild(52,215,226,231);
logoBuild(53,34,105,155);
logoBuild(54,46,112,160);
logoBuild(55,251,252,253);
logoBuild(56,255,255,255);
logoBuild(57,237,243,246);
logoBuild(58,140,170,197);
logoBuild(59,237,243,246);
logoBuild(60,255,255,255);
logoBuild(61,243,239,240);
logoBuild(62,206,223,235);
logoBuild(63,255,255,255);
logoBuild(64,255,255,255);
logoBuild(65,17,93,149);
logoBuild(66,126,167,195);
logoBuild(67,194,215,226);
logoBuild(68,237,236,239);
logoBuild(69,255,255,255);
logoBuild(70,255,255,255);
logoBuild(71,250,250,250);
logoBuild(72,98,131,165);
logoBuild(73,154,190,212);
logoBuild(74,24,97,151);
logoBuild(75,255,255,255);
logoBuild(76,241,248,251);
logoBuild(77,104,135,169);
logoBuild(78,253,252,251);
logoBuild(79,255,255,255);
logoBuild(80,255,255,255);
logoBuild(81,255,255,255);
logoBuild(82,249,246,246);
logoBuild(83,125,149,176);
logoBuild(84,245,247,248);
logoBuild(85,57,120,165);
logoBuild(86,130,149,176);
logoBuild(87,241,239,239);
logoBuild(88,255,255,255);
logoBuild(89,255,255,255);
logoBuild(90,255,255,255);
logoBuild(91,255,255,255);
logoBuild(92,255,255,255);
logoBuild(93,255,255,255);
logoBuild(94,152,188,211);
logoBuild(95,247,247,249);
logoBuild(96,255,255,255);
...
logoBuild(104,249,251,252);
logoBuild(105,221,234,242);
logoBuild(106,255,255,255);
...
logoBuild(113,255,255,255);
logoBuild(114,255,255,255);
...
logoBuild(122,235,13,23);
logoBuild(123,235,13,23);
logoBuild(124,235,13,23);
logoBuild(125,235,13,23);
logoBuild(126,235,13,23);
logoBuild(127,235,13,23);
logoBuild(128,255,255,255);
logoBuild(129,255,255,255);
logoBuild(130,255,255,255);
logoBuild(131,255,255,255);
logoBuild(132,235,13,23);
logoBuild(133,235,13,23);
logoBuild(134,235,13,23);
logoBuild(135,235,13,23);
logoBuild(136,235,13,23);
logoBuild(137,235,13,23);
logoBuild(138,255,255,255);
logoBuild(139,255,255,255);
logoBuild(140,240,240,240);
logoBuild(141,240,240,240);
logoBuild(142,235,13,23);
logoBuild(143,235,13,23);
logoBuild(144,235,13,23);
logoBuild(145,235,13,23);
logoBuild(146,235,13,23);
logoBuild(147,235,13,23);
logoBuild(148,240,240,240);
logoBuild(149,240,240,240);
logoBuild(150,240,240,240);
logoBuild(151,240,240,240);
logoBuild(152,239,45,53);
logoBuild(153,237,54,65);
logoBuild(154,240,87,94);
logoBuild(155,238,69,76);
logoBuild(156,238,57,64);
logoBuild(157,240,51,59);
logoBuild(158,240,240,240);
logoBuild(159,240,240,240);
logoBuild(160,255,255,255);
logoBuild(161,255,255,255);
logoBuild(162,235,13,23);
logoBuild(163,235,13,23);
logoBuild(164,235,13,23);
logoBuild(165,235,13,23);
logoBuild(166,235,13,23);
logoBuild(167,235,13,23);
logoBuild(168,255,255,255);
logoBuild(169,255,255,255);
logoBuild(170,255,255,255);
logoBuild(171,255,255,255);
logoBuild(172,235,13,23);
logoBuild(173,235,13,23);
logoBuild(174,235,13,23);
logoBuild(175,235,13,23);
logoBuild(176,235,13,23);
logoBuild(177,235,13,23);
logoBuild(178,255,255,255);
logoBuild(179,255,255,255);
logoBuild(180,255,255,255);
logoBuild(181,255,255,255);
logoBuild(182,235,13,23);
logoBuild(183,235,13,23);
logoBuild(184,235,13,23);
logoBuild(185,235,13,23);
logoBuild(186,235,13,23);
logoBuild(187,235,13,23);
logoBuild(188,255,255,255);
logoBuild(189,255,255,255);
logoBuild(190,255,255,255);
logoBuild(191,255,255,255);
logoBuild(192,255,255,255);
logoBuild(193,255,255,255);
logoBuild(194,255,255,255);
logoBuild(195,255,255,255);
logoBuild(196,255,255,255);
logoBuild(197,255,255,255);
